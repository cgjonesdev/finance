...
app.add_url_rule('/balance_sheet/<string:name>/update', view_func=views.BalanceSheetView.as_view('balance_sheet-update'))
app.add_url_rule('/balance_sheet/<string:name>/delete', view_func=views.BalanceSheetView.as_view('balance_sheet-delete'))
